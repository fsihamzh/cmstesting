...
def staff_apply_leave(request):
    ...
    # Filter leave history based on status if provided in the URL query params
    status = request.GET.get('status', None)  # Get status from URL query parameter

    # Fetch leave history based on staff and optional status filter
