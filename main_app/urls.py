...
#relief
    path("staff/check/availability/", hod_views.admin_check_availability, name="admin_check_availability",),
    path("staff/assign/relief/", hod_views.admin_assign_relief, name="admin_assign_relief",),
    path("staff/select/relief/<int:timetable_id>/", hod_views.select_assign_relief, name="select_assign_relief",),
#timetable
    path("manage/timetable/", hod_views.manage_timetable, name="manage_timetable",),
    path("create/timetable/", hod_views.create_timetable, name="create_timetable"),
    path("view/timetable/<int:staff_id>/", hod_views.view_timetable, name="view_timetable"),
    path("edit/<int:timetable_id>/", hod_views.edit_timetable, name="edit_timetable"),
    path("delete/<int:timetable_id>/", hod_views.delete_timetable, name="delete_timetable"),
